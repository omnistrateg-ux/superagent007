...
TRAIL_TIERS = {
    ...
    # Дать позиции дышать! Не ставить breakeven слишком рано
    35: (60, "ЗАЩИТА"),       # 35% к цели → стоп держит 40% прибыли
    50: (40, "ТРЕЙЛ_1"),      # 50% к цели → держим 60% прибыли
    65: (25, "ТРЕЙЛ_2"),      # 65% к цели → держим 75% прибыли
    80: (15, "ТРЕЙЛ_3"),      # 80% к цели → держим 85% прибыли
    90: (8,  "ЦЕЛЬ_БЛИЗКО"),  # 90% к цели → держим 92% прибыли
}
TRAIL_ACTIVATE_PCT = 35   # Активация трейлинга позже (было 15)
